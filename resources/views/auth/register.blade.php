...
<head>
    ...
    @endif
    <title>StokBarang.id | Register</title>
</head>

<body>
    <div class="flex justify-center items-center min-h-screen min-w-full">
        <div class="flex justify-center items-center">
            <form class="flex flex-col gap-5 min-w-[8cm]" action="{{ route('RegisterUser') }}" method="POST">
                @if(session('success'))
                ...
                <a class="text-center text-primary" href="/">Back to Home</a>
            </form>
